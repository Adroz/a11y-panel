  ...
  return (
    <header className="flex items-center gap-2 border-b border-zinc-200 bg-white px-4 py-3">
      ...
      <button
        onClick={startScan}
        disabled={isScanning}
        className="ml-auto flex cursor-pointer items-center gap-1.5 rounded-md bg-zinc-900 px-3 py-1.5 text-xs font-medium text-white transition-colors hover:bg-zinc-700 disabled:cursor-not-allowed disabled:opacity-50"
      >
        {isScanning ? (
          <>
